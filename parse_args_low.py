...
def parse_args():
    ...
    parser.add_argument('--num_img', type=int, default=10000, help="Number of images to generate")
    ...
    parser.add_argument('--corpus_mode', type=str, default='low', choices=['random', 'chn', 'eng', 'list', 'low'],
    ...
    parser.add_argument('--distribute_file', type=str, default='./data/label_analysis.txt',
                        help="charset distribute file path")
